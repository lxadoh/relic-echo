...
- 叙事结构(改版中):原版每段故事为 3–5 屏线性阅读 + 结尾 1 个轻选择;现升级为多分支互动叙事,搪瓷缸为打样——14 个剧情节点、3 个选择点(选项带性格倾向标签)、3 条结局线、1 个隐藏彩蛋。人物插画按固定模板生成(横版 16:9 全屏构图,人物位于左侧三分之一,右侧与下半部留暗区叠文字与选择按钮;宽屏铺满全屏、文字栏停靠右侧,窄屏完整显示);选项区固定于页面底部,正文区独立滚动,互不遮挡。其余 7 件待打样确认后按同一模板改写,剧本与美术规格见《分支剧本-搪瓷缸》。
